...
SRC_URI="mirror://sourcery/mips-4.3-221-mips-sde-elf-i686-pc-linux-gnu.tar.bz2"
...
COMPILER_DIR="/opt/toolchains/mips-4.3"
COMPILER_TOPDIR="${COMPILER_DIR}/bin"

CTNG_PREFIX="mips-4.3"
S="${WORKDIR}/${CTNG_PREFIX}"



SYSTEM_TUPLES="mipsel-sde-sourcery-linux-gnu"
CT_PREFIX="mips-sde-elf"
ORIG_SYSTEM_TUPLES="mips-sde-elf"

XGCC_VERSION="4.3.3"
XBINUTILS_VERSION="2.19.51"
